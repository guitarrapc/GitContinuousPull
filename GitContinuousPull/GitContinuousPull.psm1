...
#>
    ...
    Begin
    {
        ...
        function GitCred
        {
            ...
            if ($null -ne (Get-ValentiaCredential -TargetName $targetName -Type Generic -ErrorAction SilentlyContinue)){ "git credential found from Windows Credential Manager as TargetName : '{0}'." -f $targetName | WriteMessage; return; }
